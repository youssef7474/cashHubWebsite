...
> = {
  ...
  watan: {
    section: "border-t border-[var(--wt-line)] bg-[var(--wt-deep)] py-20 lg:py-28",
    shell: "watan-shell max-w-3xl",
    eyebrow: "watan-eyebrow",
    title: "watan-display mt-4 text-5xl text-[var(--wt-white)] sm:text-6xl",
    subtitle: "mt-3 text-[var(--wt-muted)]",
    list: "mt-12 divide-y divide-[var(--wt-line)] border border-[var(--wt-line)] bg-[var(--wt-panel)]/40",
    item: "px-5 py-5 sm:px-6",
    question: "font-semibold text-[var(--wt-white)]",
    answer: "text-sm leading-relaxed text-[var(--wt-muted)]",
    icon: "border border-[var(--wt-line)] text-[var(--wt-soft)]",
    iconOpen: "rotate-180 border-[var(--wt-gold)] text-[var(--wt-gold)]",
  },
  parlor: {
    section: "parlor-paper py-20 lg:py-28",
    shell: "parlor-shell max-w-3xl",
    eyebrow: "parlor-eyebrow",
    title: "parlor-display mt-3 text-4xl text-[var(--pl-navy)] sm:text-5xl",
    subtitle: "mt-3 text-[var(--pl-soft)]",
    list: "mt-12 divide-y-2 divide-dotted divide-[var(--pl-line)] border-2 border-[var(--pl-navy)] bg-[var(--pl-card)]",
    item: "px-5 py-5 sm:px-6",
    question: "font-bold text-[var(--pl-navy)]",
    answer: "text-sm leading-relaxed text-[var(--pl-soft)]",
    icon: "border-2 border-[var(--pl-navy)] text-[var(--pl-navy)]",
    iconOpen: "rotate-180 border-[var(--pl-red)] bg-[var(--pl-red)] text-white",
  },
  fleur: {
