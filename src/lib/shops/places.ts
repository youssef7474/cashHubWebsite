...
const PLACE_NAMES: Record<string, LocalizedString> = {
  ...
  "sharm el-sheikh": { ar: "شرم الشيخ", en: "Sharm El Sheikh" },
  // Saudi Arabia — codes match the platform's city picker (lower-cased).
  ...
  khamismushait: { ar: "خميس مشيط", en: "Khamis Mushait" },
  abha: { ar: "أبها", en: "Abha" },
  hail: { ar: "حائل", en: "Hail" },
  najran: { ar: "نجران", en: "Najran" },
  jazan: { ar: "جازان", en: "Jazan" },
  yanbu: { ar: "ينبع", en: "Yanbu" },
  alkharj: { ar: "الخرج", en: "Al Kharj" },
  hafralbatin: { ar: "حفر الباطن", en: "Hafr Al Batin" },
  albaha: { ar: "الباحة", en: "Al Baha" },
