...
const ui = {
  ar: {
    ...
    navContact: "تواصل",
    navServices: "الخدمات",
    servicesBadge: "قائمتنا",
    servicesTitle: "خدماتنا وأسعارنا",
    servicesSubtitle: "تصفح خدماتنا وأسعارها.",
    bookNow: "احجز الآن",
    heroCta: "احجز موعدك",
  ...
  en: {
    ...
    servicesBadge: "Our menu",
    servicesTitle: "Services & prices",
    servicesSubtitle: "Browse our services and prices.",
    bookNow: "Book now",
